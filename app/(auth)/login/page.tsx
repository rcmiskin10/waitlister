...
import { signIn, signInWithGoogle, signInWithGithub, type AuthActionResult } from '@/actions/auth'
    ...
    <div className="relative overflow-hidden rounded-3xl border border-neutral-200 bg-white shadow-xl shadow-neutral-900/5 dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <div className="p-8">
        ...
        <p className="mt-8 text-center text-sm text-neutral-600 dark:text-neutral-400">
          ...
          <Link href="/signup" className="font-semibold text-violet-600 hover:text-violet-700 dark:text-violet-400 dark:hover:text-violet-300">
            Sign up
          </Link>
        </p>
      </div>
